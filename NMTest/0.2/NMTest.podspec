...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/jiangyancong/NingMiPlatform"
  ...
  s.source       = { :git => "https://github.com/jiangyancong/NingMiPlatform.git", :tag => "v#{s.version}" }
  ...
  s.source_files  ="TestGitHub/TestGitHub/**/*.{h,m}","TestGitHub/TestGitHub/"
